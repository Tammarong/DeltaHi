...
test('admin dashboard reads real download records and shows downloaded at', () => {
  ...
  assert.match(adminPage, /verificationStatus:\s*verificationStatusFilter\.value === 'all' \? undefined : verificationStatusFilter\.value/)
  ...
  assert.match(adminPage, /watch\(\[debouncedSearchQuery, osFilter, verificationStatusFilter, dateFromFilter, dateToFilter\]/)
  ...
  assert.match(adminPage, /winnerSort\.value === 'highest' \? -referDifference : referDifference/)
  ...
  assert.match(adminPage, /Page \{\{ winnerPage \}\} of \{\{ winnerPageCount \}\}/)
